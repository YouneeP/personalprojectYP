      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            ...
            nutritionArray[i].nutrients[j].value += nutritionArray[i].nutrients[j].value;
            console.log(nutritionArray[i].nutrients[j].value);
          }
...
//# sourceMappingURL=0.a02906218ba16c73e836.hot-update.js.map