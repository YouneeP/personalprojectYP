  ...
  _createClass(User, [{
    ...
    value: function getRecipe() {
      ...
      if (i === 0) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.get('https://www.foodnetwork.com/topics/high-fiber-recipes', function (response) {
          var challenges = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(response).find('o-SiteSearchResults').length;
...
//# sourceMappingURL=0.8a2dbefbd4dda24dbe2d.hot-update.js.map