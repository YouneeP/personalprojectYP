      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            ...
            var foodEnergy = parseInt(nutritionArray[i].nutrients[j].value);
            console.log("Current Energy: " + this.state.energy);
            var currentEnergy = parseInt(this.state.energy);
            var NewEnergy = foodEnergy + currentEnergy;
...
//# sourceMappingURL=0.41c417d095b11dab1c59.hot-update.js.map