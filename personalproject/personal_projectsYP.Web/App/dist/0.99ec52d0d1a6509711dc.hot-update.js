    ...
    value: function getNutrientView() {
      ...
      for (var y = 0; y < aggValues.length; y++) {
        if (aggValues[y].nutrient_id == "208") {
          console.log("Energy:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "203") {
          console.log("Protein:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "204") {
          console.log("Fat:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "606") {
          console.log("Saturated Fatty Acids:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "205") {
          console.log("Carbohydrates:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "269") {
          console.log("Sugars:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "307") {
          console.log("Sodium:" + aggValues[y].value);
        } else if (aggValues[y].nutrient_id == "291") {
          console.log("Dietary Fibre:" + aggValues[y].value);
        }
      }
    }
  }, {
...
//# sourceMappingURL=0.99ec52d0d1a6509711dc.hot-update.js.map