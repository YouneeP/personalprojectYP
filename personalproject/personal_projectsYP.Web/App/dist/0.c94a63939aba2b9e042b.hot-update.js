...
var User = function (_Component) {
  ...
  _createClass(User, [{
    ...
    value: function getByAccountId() {
      ...
      fetch("/api/user/" + accountId, {
        ...
        this.setState({
          ...
          return console.log(_this3.state.user);
        });
      }.bind(this));
    }
  }, {
    ...
    value: function submit(event) {
      ...
      var accountId = cookie.split("=")[1];
      this.setState({ accountId: accountId }, function () {
        return fetch("/api/user/meal", {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            AccountId: _this4.state.accoundId,
            Meal: _this4.state.meal,
            Quantity: _this4.state.quantity
          }),
          credentials: 'include'
        }).then(function (resp) {
          return resp.json();
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          this.state.user.map(function (user) {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'col-md-4 m-5-sm m-l-md', key: user.Id, __source: {
                fileName: _jsxFileName,
                lineNumber: 77
              },
              __self: _this5
...
//# sourceMappingURL=0.c94a63939aba2b9e042b.hot-update.js.map