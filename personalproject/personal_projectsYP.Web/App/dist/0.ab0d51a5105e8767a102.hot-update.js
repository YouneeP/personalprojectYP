    ...
    value: function getCalculate() {
      ...
      for (var i = 0; i < userMeal.length; i++) {
        fetch("https://api.nal.usda.gov/ndb/search/?format=json&q=" + userMeal[i].Meal + "&sort=n&max=25&offset=0&api_key=iePhBf4DTI9UStixHQvpqeNZnlICZEKRITy2HpQV", {
          ...
          fetch("https://api.nal.usda.gov/ndb/reports/?ndbno=" + ndbono + "6&type=b&format=json&api_key=iePhBf4DTI9UStixHQvpqeNZnlICZEKRITy2HpQV", {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
          }).then(function (resp) {
            return resp.json();
...
//# sourceMappingURL=0.ab0d51a5105e8767a102.hot-update.js.map