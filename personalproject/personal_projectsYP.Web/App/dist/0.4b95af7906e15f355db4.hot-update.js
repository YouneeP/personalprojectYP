...
var User = function (_Component) {
  ...
  _createClass(User, [{
    ...
    value: function getNutrientView() {
      var nutArr = [{
        name: "Cheese Burger",
        nutsArr: [{ id: 1, name: "Energy", value: 10 }, { id: 2, name: "Protein", value: 15 }]
      }, {
        name: "Pizza",
        nutsArr: [{ id: 1, name: "Energy", value: 11 }, { id: 2, name: "Protein", value: 12 }]
      }];
      console.log(nutArr);
      var aggValues = [];
      for (var i = 0; i < nutArr.length; i++) {
        for (var j = 0; j < nutArr[i].nutsArr.length; j++) {
          var singleVal = nutArr[i].nutsArr[j];
          var oldVal = aggValues.find(function (e) {
            return e.id == singleVal.id;
          });
          if (oldVal) {
            oldVal.value = oldVal.value + singleVal.value;
          } else {
            aggValues.push(singleVal);
          }
        }
      }
      console.log("Here is the value of aggValues: ", aggValues);
      ...
      //     var oldVal = aggValues.find((e) => e.id ==singleVal.id);
      //     if(oldVal){
...
//# sourceMappingURL=0.4b95af7906e15f355db4.hot-update.js.map