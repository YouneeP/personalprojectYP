    ...
    value: function getNutrientView() {
      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          // console.log(nutritionArray[i].nutrients[j].nutrient_id);
          // console.log(nutritionArray[i].name + nutritionArray[i].nutrients[j].nutrient_id);
        }
      }
...
//# sourceMappingURL=0.c8b14681e823198c7e9f.hot-update.js.map