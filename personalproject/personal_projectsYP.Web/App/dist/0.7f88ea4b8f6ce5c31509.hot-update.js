...
var Login = function (_Component) {
    ...
    _createClass(Login, [{
            ...
            fetch("/api/user/login", {
                ...
                if (item.Id != 0) {
                    alert("Login Success").then(function () {
                        return _this2.setState({ redirect: true }).bind(_this2);
                    });
                } else if (item.Id === 0) {
        ...
        value: function render() {
            ...
            if (redirect) {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["Redirect"], { to: '/user', __source: {
...
//# sourceMappingURL=0.7f88ea4b8f6ce5c31509.hot-update.js.map