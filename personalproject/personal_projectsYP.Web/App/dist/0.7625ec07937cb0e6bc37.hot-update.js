      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            ...
            // let energy = parseInt(this.state.energy);
            // console.log("Current Energy: " + energy);
            // let newEnergy = parseInt(this.state.energy+nutritionArray[i].nutrients[j].value);
            // console.log("New Energy: " + newEnergy);
            // let finalEnergy = energy+newEnergy;
            // console.log("Final Energy: " + finalEnergy);
            // this.setState({energy:finalEnergy},()=>console.log(this.state.energy));
          }
...
//# sourceMappingURL=0.7625ec07937cb0e6bc37.hot-update.js.map