  ...
  _createClass(User, [{
    ...
    value: function getCalculate() {
      ...
      for (var i = 0; i < userMeal.length; i++) {
        ...
        } else if (userMeal[i].Quantity === 2) {
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
        } else if (userMeal[i].Quantity === 3) {
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
        } else if (userMeal[i].Quantity === 4) {
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
        } else if (userMeal[i].Quantity === 5) {
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
          foodArray.push(userMeal[i].Meal);
...
//# sourceMappingURL=0.57b7a47fbc3252d01973.hot-update.js.map