...
var User = function (_Component) {
  ...
  _createClass(User, [{
    ...
    value: function submit(event) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#imageInput').change(function () {
        var frm = new FormData();
        frm.append('imageInput', input.files[0]);
        __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
          method: 'POST',
          address: 'api/user/image',
          data: frm,
          contentType: false,
          processData: false,
          cache: false
...
//# sourceMappingURL=0.9d9707b16c3a48ebef89.hot-update.js.map