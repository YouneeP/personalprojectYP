    ...
    value: function getUserMeal() {
      ...
      fetch("/api/user/todaymeal/" + accountId, {
        ...
        for (var i = 0; i++; i < item.length) {
          item[i].CreatedDateOnly = item[i].CreatedDate.splt("T")[0];
        }
        this.setState({
          userMeal: item
        }, function () {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                _this6.state.userMeal.map(function (userMeal) {
                  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'card-header bg-dark text-white', key: userMeal.CreatedDateOnly, __source: {
                        fileName: _jsxFileName,
                        lineNumber: 124
                      },
                      __self: _this6
                    },
                    userMeal.CreatedDateOnly,
                    ', ',
                    user.FirstName,
                    ' ',
                    user.LastName,
...
//# sourceMappingURL=0.df29434c44c0375e64c8.hot-update.js.map