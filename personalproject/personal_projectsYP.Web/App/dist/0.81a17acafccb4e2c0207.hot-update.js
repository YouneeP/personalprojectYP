    ...
    value: function getNutrientView() {
      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          var singleVal = nutritionArray[i].nutrients[j];
          ...
          if (oldVal) {
            ...
            aggValue.push(singleVal);
          }
        }
      }
      console.log("new value" + aggValues);
    }
  }, {
    key: 'render',
...
//# sourceMappingURL=0.81a17acafccb4e2c0207.hot-update.js.map