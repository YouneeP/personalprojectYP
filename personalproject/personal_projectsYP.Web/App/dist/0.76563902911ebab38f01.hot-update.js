  ...
  _createClass(User, [{
    ...
    value: function getnbdno(counter) {
      ...
      fetch("https://api.nal.usda.gov/ndb/search/?format=json&q=" + array[counter] + "&sort=n&max=25&offset=0&api_key=iePhBf4DTI9UStixHQvpqeNZnlICZEKRITy2HpQV", {
        ...
        if (counter === length) {
          var ndbono = data.list.item[0].ndbno;
          this.getNutrient(ndbono);
          return;
        } else {
          var _ndbono = data.list.item[0].ndbno;
          this.getNutrient(_ndbono);
    ...
    key: 'getNutrient',
    value: function getNutrient(ndbono) {
      var _this9 = this;
      ...
      fetch("https://api.nal.usda.gov/ndb/reports/?ndbno=" + ndbono + "&type=b&format=json&api_key=iePhBf4DTI9UStixHQvpqeNZnlICZEKRITy2HpQV", {
        ...
        return resp.json().then(function (data) {
          ...
          this.setState({ nutritionArray: nutritionArray }, function () {
            return console.log(_this8.state.nutritionArray);
          });
        }.bind(_this9));
      });
    }
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  ...
                  _this10.state.userMeal.map(function (userMeal) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                      'div',
                      ...
                      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                          'button',
                          {
                            ...
                            onClick: function onClick() {
                              return _this10.edit(userMeal.Id);
                            },
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-close m-l-xs', onClick: function onClick() {
                            return _this10.delete(userMeal.Id);
                          }, __source: {
                            fileName: _jsxFileName,
                            lineNumber: 243
                          },
                  ...
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'button',
                    { type: 'button', className: 'btn btn-primary m-t-md', onClick: _this10.getCalculate, __source: {
                        fileName: _jsxFileName,
                        lineNumber: 247
                      },
                      __self: _this10
              ...
              _this10.state.resultMode === true ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
...
//# sourceMappingURL=0.76563902911ebab38f01.hot-update.js.map