      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            ...
            var Engery = [].concat(_toConsumableArray(this.state.energy));
            var newEnergy = Energy + nutritionArray[i].nutrients[j].value;
...
//# sourceMappingURL=0.0524da43ecc54275c03c.hot-update.js.map