  ...
  _createClass(User, [{
    ...
    value: function getNutrientView() {
      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            console.log("Food Energy:" + nutritionArray[i].nutrients[j].value);
            this.state.energy += parseInt(nutritionArray[i].nutrients[j].value);
            // let foodEnergy = parseInt(nutritionArray[i].nutrients[j].value);
            // console.log("Current Energy: " + this.state.energy);
            // let currentEnergy = parseInt(this.state.energy);
            // let NewEnergy = foodEnergy + currentEnergy;
            // console.log("Added Energy:" + NewEnergy);
            // this.setState({energy:NewEnergy});
          }
          if (nutritionArray[i].nutrients[j].nutrient_id === "203") {
            //console.log("Protein:" + nutritionArray[i].nutrients[j].value);
          }
          if (nutritionArray[i].nutrients[j].nutrient_id === "204") {
            //console.log("fat:" + nutritionArray[i].nutrients[j].value);
          }
          if (nutritionArray[i].nutrients[j].nutrient_id === "205") {
            //console.log("carbohydrates:" + nutritionArray[i].nutrients[j].value);
          }
          if (nutritionArray[i].nutrients[j].nutrient_id === "269") {
            //console.log("sugar:" + nutritionArray[i].nutrients[j].value);
          }
          if (nutritionArray[i].nutrients[j].nutrient_id === "307") {
            //console.log("sodium:" + nutritionArray[i].nutrients[j].value);
          }
          alert(this.state.energy);
        }
      }
    }
  }, {
...
//# sourceMappingURL=0.5a505a862b40d540f9e9.hot-update.js.map