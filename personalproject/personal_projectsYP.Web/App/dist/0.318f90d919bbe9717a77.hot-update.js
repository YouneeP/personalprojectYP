    ...
    value: function getNutrientView() {
      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          ...
          } else if (nutritionArray[i].nutrients[j].nutrient_id === "203") {
            console.log("Protein:" + nutritionArray[i].nutrients[j].value);
          } else if (nutritionArray[i].nutrients[j].nutrient_id === "204") {
            console.log("fat:" + nutritionArray[i].nutrients[j].value);
          } else if (nutritionArray[i].nutrients[j].nutrient_id === "205") {
            console.log("carbohydrates:" + nutritionArray[i].nutrients[j].value);
          } else if (nutritionArray[i].nutrients[j].nutrient_id === "269") {
            console.log("sugar:" + nutritionArray[i].nutrients[j].value);
          } else if (nutritionArray[i].nutrients[j].nutrient_id === "307") {
...
//# sourceMappingURL=0.318f90d919bbe9717a77.hot-update.js.map