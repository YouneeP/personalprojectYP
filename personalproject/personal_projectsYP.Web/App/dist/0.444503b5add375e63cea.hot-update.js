...
var User = function (_Component) {
  ...
  _createClass(User, [{
      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            ...
            this.getEnergy(nutritionArray[i].nutrients[j].value);
          }
    ...
    key: 'getEnergy',
    value: function getEnergy(energy) {
      var _this11 = this;

      var recievedenergy = parseInt(this.state.energy);
      var currentEnergy = parseInt(this.state.energy);
      var newEnergy = currentEnergy + recievedenergy;
      this.setState({ energy: newEnergy }, function () {
        return console.log(_this11.state.energy);
      });
    }
  }, {
    key: 'render',
...
//# sourceMappingURL=0.444503b5add375e63cea.hot-update.js.map