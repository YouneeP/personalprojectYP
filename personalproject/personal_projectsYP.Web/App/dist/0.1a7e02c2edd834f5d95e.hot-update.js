      ...
      for (var i = 0; i < nutritionArray.length; i++) {
        for (var j = 0; j < nutritionArray[i].nutrients.length; j++) {
          if (nutritionArray[i].nutrients[j].nutrient_id === "208") {
            console.log("Energy:" + nutritionArray[i].nutrients[j].value);
            var energy = parseInt(this.state.energy);
            console.log("Current Energy: " + energy);
            var newEnergy = parseInt(this.state.energy + nutritionArray[i].nutrients[j].value);
            console.log("New Energy: " + newEnergy);
            var finalEnergy = energy + newEnergy;
            console.log("Final Energy: " + finalEnergy);
            this.setState({ energy: finalEnergy }, function () {
...
//# sourceMappingURL=0.1a7e02c2edd834f5d95e.hot-update.js.map